...
These are some of the configurations I use on a daily basis!
...
## VS Code Extensions (enabled as needed)
...
1. [Fantastic](https://marketplace.visualstudio.com/items?itemName=sldobri.daily)
...
### Product Icons
1. [Fluent Icons](https://marketplace.visualstudio.com/items?itemName=miguelsolorio.fluent-icons)
...
- Find themes at [WindowsTerminalThemes.dev](https://windowsterminalthemes.dev)
